...
/* harmony import */ var _components_UploadPage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/UploadPage */ "./src/admin/components/UploadPage.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.routes['fof-upload'] = {
    path: '/fof/upload',
    component: _components_UploadPage__WEBPACK_IMPORTED_MODULE_4__["default"]
  };

  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.extensionSettings['fof-upload'] = function () {
    return m.route.get(flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.route('fof-upload'));
  };
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_AdminNav__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'items', function (items) {
    items.add('fof-upload', flarum_components_AdminLinkButton__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      href: flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.route('fof-upload'),
      icon: 'far fa-file',
      description: flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('fof-upload.admin.pane.description')
    }, flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('fof-upload.admin.pane.title')));
  });
});
...
/* harmony import */ var flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! flarum/utils/withAttr */ "flarum/utils/withAttr");
/* harmony import */ var flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9__);
...
var UploadPage = /*#__PURE__*/function (_Component) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    _Component.prototype.oninit.call(this, vnode); // whether we are saving the settings or not right now
    ...
    'imgurClientId', // AWS
    'awsS3Key', 'awsS3Secret', 'awsS3Bucket', 'awsS3Region', // QIniu
    'qiniuKey', 'qiniuSecret', 'qiniuBucket']; // the checkboxes we need to watch and to save.

    this.checkboxes = ['mustResize', 'addsWatermarks', 'disableHotlinkProtection', 'disableDownloadLogging']; // fields that are objects
    ...
    this.fields.forEach(function (key) {
      return _this.values[key] = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()(settings[_this.addPrefix(key)]);
    });
    this.checkboxes.forEach(function (key) {
      return _this.values[key] = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()(settings[_this.addPrefix(key)] === '1');
    });
    this.objects.forEach(function (key) {
      return _this.values[key] = settings[_this.addPrefix(key)] ? flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()(JSON.parse(settings[_this.addPrefix(key)])) : flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()();
    }); // Set a sane default in case no mimeTypes have been configured yet.

    this.values.mimeTypes() || (this.values.mimeTypes = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()({
      '^image\\/.*': {
        adapter: 'local',
    ...
    this.newMimeType = {
      regex: flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()(''),
      adapter: flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()('local'),
      template: flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()('file')
    };
  }
  /**
  ...
  _proto.view = function view() {
    ...
    return [m('.UploadPage', [m('.container', [m('form', {
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.maxFileSize)
      ...
      return m('div', [m('input.FormControl.MimeTypes', {
        value: mime,
        oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', _this2.updateMimeTypeKey.bind(_this2, mime))
      }), flarum_components_Select__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.resizeMaxWidth),
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.cdnUrl)
    })]), m('fieldset', [m('legend', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-upload.admin.labels.imgur.title')), m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-upload.admin.labels.imgur.client_id')), m('input.FormControl', {
      value: this.values.imgurClientId() || '',
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.imgurClientId)
    })]), m('fieldset', [m('legend', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-upload.admin.labels.qiniu.title')), m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-upload.admin.labels.qiniu.key')), m('input.FormControl', {
      value: this.values.qiniuKey() || '',
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.qiniuKey)
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.qiniuSecret)
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.qiniuBucket)
    })]), m('fieldset', [m('legend', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-upload.admin.labels.aws-s3.title')), m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-upload.admin.labels.aws-s3.key')), m('input.FormControl', {
      value: this.values.awsS3Key() || '',
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.awsS3Key)
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.awsS3Secret)
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.awsS3Bucket)
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.awsS3Region)
    })]), flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      type: 'submit',
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    flarum_utils_saveSettings__WEBPACK_IMPORTED_MODULE_4___default()(settings).then(function () {
      ...
      _this4.successAlert = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.alerts.show(flarum_components_Alert__WEBPACK_IMPORTED_MODULE_5___default.a, {
        type: 'success'
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('fof-upload', function (app) {
  // add the admin pane
