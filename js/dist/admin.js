...
class UploadPage extends (flarum_admin_components_ExtensionPage__WEBPACK_IMPORTED_MODULE_11___default()) {
  ...
  oninit(vnode) {
    ...
    this.fields = ['resizeMaxWidth', 'thumbnailMaxWidth', 'cdnUrl', 'maxFileSize', 'whitelistedClientExtensions', 'composerButtonVisiblity', 'watermark', 'watermarkPosition', 'watermarkSizePercent', 'watermarkOpacity', 'watermarkPadding', 'imgurClientId', 'awsS3Key', 'awsS3Secret', 'awsS3Bucket', 'awsS3Region', 'awsS3Endpoint', 'awsS3ACL', 'awsS3CustomUrl', 'qiniuKey', 'qiniuSecret', 'qiniuBucket'];
    this.checkboxes = ['mustResize', 'generateThumbnails', 'thumbnailWebp', 'addsWatermarks', 'disableHotlinkProtection', 'disableDownloadLogging', 'awsS3UsePathStyleEndpoint', 'svgAnimateAllowed'];
  ...
  content(vnode) {
    var _this$values$maxFileS, _this$values$resizeMa, _this$values$thumbnai, _this$values$whitelis, _this$values$watermar, _this$values$watermar2, _this$values$watermar3, _this$values$cdnUrl;
    ...
    return m("div", {
      ...
      className: "Form-group"
    }, m("legend", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.thumbnails.title')), m("p", {
      className: "helpText"
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.help_texts.thumbnails')), m("div", {
      className: "Form-group"
    }, m((flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_6___default()), {
      state: this.values.generateThumbnails() || false,
      onchange: this.values.generateThumbnails
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.thumbnails.toggle'))), m("div", {
      className: "Form-group"
    }, m((flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_6___default()), {
      state: this.values.thumbnailWebp() || false,
      onchange: this.values.thumbnailWebp,
      disabled: !this.values.generateThumbnails()
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.thumbnails.webp_toggle'))), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.thumbnails.max_width')), m("input", {
      className: "FormControl",
      type: "number",
      min: "100",
      max: "4000",
      value: (_this$values$thumbnai = this.values.thumbnailMaxWidth()) != null ? _this$values$thumbnai : 1000,
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.thumbnailMaxWidth),
      disabled: !this.values.generateThumbnails()
    }))), m("fieldset", {
      className: "Form-group"
      ...
      className: "Form-group"
    }, m("label", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.watermark.size_percent')), m("input", {
      className: "FormControl",
      type: "number",
      min: "1",
      max: "100",
      value: (_this$values$watermar = this.values.watermarkSizePercent()) != null ? _this$values$watermar : 25,
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.watermarkSizePercent),
      disabled: !this.values.addsWatermarks()
    })), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.watermark.opacity')), m("input", {
      className: "FormControl",
      type: "number",
      min: "0",
      max: "100",
      value: (_this$values$watermar2 = this.values.watermarkOpacity()) != null ? _this$values$watermar2 : 100,
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.watermarkOpacity),
      disabled: !this.values.addsWatermarks()
    })), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('fof-upload.admin.labels.watermark.padding')), m("input", {
      className: "FormControl",
      type: "number",
      min: "0",
      value: (_this$values$watermar3 = this.values.watermarkPadding()) != null ? _this$values$watermar3 : 10,
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.values.watermarkPadding),
      disabled: !this.values.addsWatermarks()
    })), m("div", {
      className: "Form-group"
